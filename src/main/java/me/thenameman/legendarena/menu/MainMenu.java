package me.thenameman.legendarena.menu;
...
import static me.thenameman.legendarena.menu.MenuCore.*;
...
public class MainMenu implements Listener {
    ...
    public MainMenu(Plugin plugin) {
        ...
        // Set the items
        ItemStack plots = createItem(Material.BRICK, ChatColor.GREEN + "Plots");
        ItemStack freebuild = createItem(Material.GOLDEN_CARROT, ChatColor.GREEN + "Freebuild");
        ItemStack survival = createItem(Material.DIAMOND_SWORD, ChatColor.GREEN + "Survival");
        ItemStack hub = createItem(Material.COMMAND, ChatColor.GREEN + "The Hub");
        ItemStack shop = createItem(Material.BAKED_POTATO, ChatColor.GREEN + "Shop");
        ItemStack minigames = createItem(Material.WORKBENCH, ChatColor.GREEN + "Minigames", ChatColor.BLUE + "Minigame list >>");

        ItemStack comingsoon = createItem(new ItemStack(Material.STAINED_GLASS_PANE, 1, (short) 14), ChatColor.RED + "Coming Soon[tm]", ChatColor.RED + "Check back later on this one!");
