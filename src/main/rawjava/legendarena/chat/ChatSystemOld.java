...
public class ChatSystemOld {
    ...
    public static void msg(Player p, String msg) {
        ...
        switch(getChannel(p)) {
            ...
            default:
                //bitch like hell, because this really should NOT be triggered in any case, no matter how logical it is
                notice("Error: Player " + ChatColor.YELLOW + p.getName() + ChatColor.DARK_PURPLE + " is trying to use an invalid channel (" + ChatColor.YELLOW + getChannel(p) + ChatColor.DARK_PURPLE + ") - THIS SHOULD NOT HAPPEN!");
                return;
        }
    }
